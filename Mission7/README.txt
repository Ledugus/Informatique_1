...
Le fichier "test.py" teste les fonctions suivantes de "search.py" : get_words(line), create_index(filename), get_lines(words, index) selon les fichiers tests "text_exemple_1.txt" et "text_exemple_2.txt".